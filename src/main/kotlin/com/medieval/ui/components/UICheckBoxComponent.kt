...
class UICheckBoxComponent(
    ...
    override var uiPrimitiveType: UIPrimitiveType = UIPrimitiveType.UI_CHECK_BOX_COMPONENT

    override fun initEntity() {

        super.initEntity()

        this@UICheckBoxComponent.gm.logMessage(message = "UI Check Box Component created!")
    }
